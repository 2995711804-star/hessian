...
%% ==================== 参数配置 ====================
data_folder = "C:\Users\PC\Desktop\claud 1\1014\球915";
width = 720;
height = 540;
prj_width = 912;
n = 6;
...
% 图3: 点云对比
% up_test_obj = phaX_4step * 2 * pi;
% x_p = phaX_4step * prj_width;
% up_test_obj = phaX_12step * 2 * pi;
% x_p = phaX_12step * prj_width;
 up_test_obj = phaX_16step * 2 * pi;
 x_p = phaX_16step * prj_width;
...
Point=Point3D(540,720,Xws,Yws,Zws);
fid=fopen('1.txt','w');
fprintf(fid,'%d %d %d\n',xyzPoints');
fclose(fid);
fid=fopen('7.txt','w');
