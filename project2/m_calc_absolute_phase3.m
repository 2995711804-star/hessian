%解绝对相位函数
function [pha_absolute, dif] = m_calc_absolute_phase3(files_phaseShift, files_grayCode, IT, B_min, win_size)
[~, N] = size(files_phaseShift);
[pha_wrapped, B] = m_calc_warppred_phase3(files_phaseShift,files_grayCode, N);
