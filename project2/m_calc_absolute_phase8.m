function [pha_absolute, dif] = m_calc_absolute_phase8(files_phaseShift, files_grayCode, IT, B_min, win_size)
[~, N] = size(files_phaseShift);
[pha_wrapped, B] = m_calc_warppred_phase8(files_phaseShift,files_grayCode, N);
