%% 计算包裹相位
function [pha, B] = m_calc_warppred_phase3(files,files_grayCode, N)
...
%计算截断相位
sin_sum=sin4*sin(2*pi/4)+sin1*sin(2*2*pi/4)+sin2*sin(3*2*pi/4)+sin3*sin(4*2*pi/4);
cos_sum=sin4*cos(2*pi/4)+sin1*cos(2*2*pi/4)+sin2*cos(3*2*pi/4)+sin3*cos(4*2*pi/4);
