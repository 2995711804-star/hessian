...
data_folder = "data/project2-12";
N = 12;
n = 5;
num = n + 2 + 1;
B_min = 7;      % 低于这个调制度的我们就认为它的相位信息不可靠
IT = 0.5;        % 格雷码阈值
win_size = 7;    % 中值滤波窗口大小
...
[phaX, difX] = m_calc_absolute_phase1(files_phaseShiftX, files_grayCodeX, IT, B_min, win_size);
