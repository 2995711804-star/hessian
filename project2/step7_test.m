...
data_folder = "date\project3-40-2";
N = 32; %8幅二值*4步相移
n = 5;
num = n + 2 + 1;
...
% figure; mesh(up_test_obj); colorbar; tle("相位图, freq=" + num2str(f));
% 
% % 计算投影仪坐标
...
[phaX, difX] = m_calc_absolute_phase3(files_phaseShiftX, files_grayCodeX, IT, B_min, win_size);
